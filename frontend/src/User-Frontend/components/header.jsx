          ...
          <div className="flex items-center justify-between px-4 sm:px-6 py-3">
            ...
            <div className="flex items-center gap-3 min-w-0">
              ...
              <button onClick={() => navigate("/user/home")} className="font-serif text-lg sm:text-xl font-bold text-white leading-tight tracking-tight hover:text-[#F47A20] transition-colors">
                Spice Hut <span className="text-[#D9A441] text-xs sm:text-sm font-normal block sm:inline">Indian Cuisine</span>
              </button>
            </div>
            ...
            <div className="flex items-center gap-2">
              <button onClick={() => navigate("/user/cart")}
                className="relative text-white hover:text-[#F47A20] transition w-11 h-11 rounded-full hover:bg-white/10 flex items-center justify-center flex-shrink-0" aria-label="Cart">
              ...
              {authed ? (
                ...
                <div className="relative" ref={dropdownRef}>
                  <button onClick={() => setShowDropdown(!showDropdown)}
                    className="text-white hover:text-[#F47A20] transition w-11 h-11 rounded-full hover:bg-white/10 flex items-center justify-center flex-shrink-0" aria-label="Profile">
